---
title: "Trends & Tendencies: Academic Research on Tabletop Role-Playing Games Up to Today"
lang: en
author:
...
This withdrawn study was a complete plagiarism of a previous article’s text, with changes to the authors and replacement of bibliographic references. The study was published online on February 19, 2024. I reported it to the authors of the original article on April 5, 2024. The *retraction* occurred on April 17, 2024[^10]. It does not appear as a withdrawn study in the *Retraction Watch* database, but it can be identified on the journal's website and on Google Scholar.

[^10]: <https://rpggeek.com/rpgperiodical/8965/> and <https://en.wikipedia.org/wiki/Interactive_Fantasy>
...
[^15]: Blog *Unwinnable* <https://unwinnable.com/2019/01/30/73260/> (2010-)
...
Role-playing culture is characterized by a strong commitment to popularizing complex concepts. The GNS theory is an emblematic example: initially abstract, it has undergone numerous clarifications and reformulations across various communication channels, making it more accessible[@torner_rpg_2018]. This desire to make theoretical concepts practical encourages participants to adopt these theories and adapt them according to their needs.
