...
Pour tenter de valoriser les citations des articles de jeux de rôles entre eux, j’ai tenté de reproduire le graphe en versant des données dans Wikidata et en les visualisant de diverses manières[^10]. Bien évidement, cette preuve de concept n’était qu’exploratoire et partielle.
...
[^11]: Recherche avec *Retraction Watch*.
...
Enfin, vers les années 2000, notons la constitution progressive et durable de bases de données indexant des références de jeux de rôles (*The Acaeum*[^13] par exemple) et parfois avec des ontologies complexes qui n’ont rien à envier aux outils de gestion de bibliothèques universitaires (Le Grog[^14] et *RPGGeek*[^15] par exemple).
