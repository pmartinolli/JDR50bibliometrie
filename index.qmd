...
Cependant, il est possible qu’une première rétraction survienne dans un cas que j’ai signalé aux auteurs originaux. En effet, la copie exacte d'un article a été publiée avec d’autres auteurs dans une revue récente.

# Discours para-universitaire

## Hors des circuits savants traditionnels

Cette étude exploratoire ne portait que sur la conversation scientifique à travers ses canaux de diffusion traditionnels : articles révisés par les pairs, mémoires et thèses, monographies ou présentations dans des colloques, etc. Cependant, la réflexion sur le jeu de rôle sur table a toujours été une composante importante de ce loisir. Or cette réflexion a lieu essentiellement hors des canaux de diffusion traditionnels de la recherche universitaire[@torner_rpg_2018].

Ainsi, des typologies et des théories ont rapidement émergé dans des articles dédiés diffusés dans des périodiques spécialisés sur le jeu de rôle : fanzines, magazines, etc. Par exemple, dans *Alarums & Excursions* dès 1975, le premier numéro contient un article de Lee Gold, sa rédactrice en chef et fondatrice, dans lequel elle définit *Dungeons & Dragons* comme n’étant pas un jeu à somme nulle tandis que *Dungeons & Beaver*, un pastiche, est un jeu à somme nulle[@gold_taintivy_1975]. De même, en 1979 plusieurs concepteurs de jeu expliquent quels sont leurs rapports personnels avec le jeu de rôle dans le premier numéro de *Different Worlds*[@kanterman_my_1979]. D’autres articles d’analyse seront diffusés dans ce magazine. Nous voyons donc que bien avant 1981, date du premier article révisé par les pairs dans la revue universitaire *Simulation & Gaming* par le professeur de sociologie Gary Alan Fine[@fine_fantasy_1981], la réflexion sur le jeu de rôle sur table est en diffusée dans les médias de la communauté des joueurs.
...
Tout d’abord, la collégialité est un point important faisant écho à la dimension intrinsèquement collaborative du jeu de rôle. Les lieux de diffusion des idées sont souvent des lieux de débats. Par exemple, les forums (*The Forge*, Les Courants alternatifs, etc.) ou les wikis sont des plateformes invitant naturellement aux échanges entre pairs. Dans les podcasts, il y a souvent des invités qui font une présentation poussée et argumentées de leurs idées, comme les chercheurs s’invitant les uns les autres sur les campus. Enfin, pour concevoir et maintenir les bases de données mentionnées plus haut, il faut des équipes robustes, pérennes et collaborant sur un objet techniquement complexe.
...
Selon moi, l’exemple le plus frappant de la similiarité de la culture de la recherche scientifique et du jeu de rôle est dans les pratiques de citation. Cette notion m’est venu en écoutant une émission de podcast de La Cellule[@briand_podcast_2018-1] qui faisait un parallèle entre la citation dans l'édifice scientifique et dans les publications de jeu de rôle. En murissant ces notions, j’ai exploré les pratiques de citations dans les jeux de rôle sur table de manière amateur en tant que chercheur indépendant. Ne jouant quasiment plus, cela me permettait d’exprimer une dimension importante de ma vie professionnelle (la citation) et de renouer avec un loisir que je considère toujours significatif dans mon identité.
...
Les règles de jeu de rôle sur table, dans leurs formes textuelles diversifiées, s’apparentent plus à celles des monographies que celles des jeux. Les règles de wargames semblent se positionner de manière intermédiaire entre ces deux identités. Selon moi, l’un des aspects les plus significatifs est la pratique de citation.

Le nombre de citations est souvent surprenament élevé.

Les intentions de citations sont nombreuses et diversifiées. On cite pour rendre hommage ou pour reconnaître le travail ou l’innovation. On cite aussi pour montrer la multitude de ses sources d’inspiration (voire nier une filiation unique). On peut aussi choisir de mal citer (ne plus citer, citer de manière biaisée, etc.). On peut citer pour faire communauté avec un groupe auquel on aspire à une certaine appartenance ou une certaine fraternité. On peut aussi citer par érudition de nombreuses sources savantes, ou par esthétique avec moults épigraphes, ou par obligation légale (OGL, GSL et autres), etc.

Enfin, tel que mentionné dans l’émission de La Cellule[@briand_podcast_2018-1], on peut citer pour montrer d’où et de qui proviennent les mécaniques de jeu réutilisées. Là aussi, avec ce type d‘attribution les formes peuvent être multiples. Cela va de la simple mention d’un auteur, ou d’un auteur et son jeu, jusqu'au détail de la mécanique spécifique qui a été réutilisée, comment elle l’a été et pourquoi. Cette intention de citation est celle qui se rapproche le plus de la référence en science. En effet, dans la publication scientifique la principale raison d’être de la citation est la traçabilité de l’information pour aller plus loin ou pour vérifier.

Selon moi, des pratiques de citation saines sont un signe de maturité et de robustesse d'une culture. Outre les liens avec le passé, elles permettent de reconnaître toute la diversité du tissu social qui la constitue, spécialement en valorisant les voix minoritaires mais significatives[@siew_one_2022]. Bref, comme je dis souvent à mes étudiant.es : « Citez-vous les uns les autres ! ».

# Conclusion

Le jeu de rôle sur table a suscité l'intérêt du monde universitaire dès son émergence, avec une intensification notable de la recherche depuis 2010. La diversité des disciplines qui s'y intéressent témoigne de sa richesse comme objet d'étude, conférant ainsi au médium une légitimité académique croissante. Cette reconnaissance institutionnelle fait écho à une culture réflexive déjà présente au sein de la communauté rôliste, qui s'exprime à travers différents supports et discussions. N'est-ce pas justement cette soif de connaissance et d'exploration intellectuelle - cette *libido sciendi* - qui permet d'étendre l'expérience ludique au-delà des parties elles-mêmes, enrichissant ainsi la pratique de ce loisir ?
